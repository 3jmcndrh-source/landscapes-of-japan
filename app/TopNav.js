...
const labels = {
  ja: { collections: "コレクション", search: "検索", random: "ランダム" },
  zh: { collections: "合集", search: "搜索", random: "随机" },
  "zh-tw": { collections: "合集", search: "搜尋", random: "隨機" },
  ko: { collections: "컬렉션", search: "검색", random: "랜덤" },
};
const fallback = { collections: "Collections", search: "Search", random: "Random" };
