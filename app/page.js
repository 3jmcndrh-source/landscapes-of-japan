...
const TR = {
  ...
  fr:{name:"Français",nav:{map:"Lieux"},hero:{t:"Paysages du Japon",s:"ー Le Japon en images ー",d:"Une collection de photos de paysages prises à travers le Japon"},mapL:"Lieux de prise de vue",mapH:"Cliquez sur une préfecture en couleur → voir les photos",backMap:"Retour à la carte",lang:"Langue",ft:"N'hésitez pas à me contacter pour toute question.",scroll:"← Glisser / Défiler →",oki:"Okinawa",tapHint:"Appuyez à nouveau → photos",mapZoomOn:"Pincer pour zoomer",mapZoomOff:"Quitter le zoom",mapZoomReset:"Réinitialiser",footer2:"Toute reproduction non autorisée est interdite.",contact:{title:"Contact",name:"Nom",email:"E-mail",msg:"Message",send:"Envoyer",sent:"Envoyé ! Merci.",err:"Échec de l'envoi. Veuillez réessayer."}},
  de:{name:"Deutsch",nav:{map:"Standorte"},hero:{t:"Landschaften Japans",s:"ー Japan im Fokus ー",d:"Eine Sammlung von Landschaftsfotos aus ganz Japan"},mapL:"Aufnahmeorte",mapH:"Klicke auf eine markierte Präfektur → Fotos ansehen",backMap:"Zurück zur Karte",lang:"Sprache",ft:"Bei Fragen oder Anregungen gerne Kontakt aufnehmen.",scroll:"← Wischen / Scrollen →",oki:"Okinawa",tapHint:"Nochmal tippen → Fotos",mapZoomOn:"Zum Zoomen zusammenziehen",mapZoomOff:"Zoom-Modus beenden",mapZoomReset:"Zurücksetzen",footer2:"Unerlaubte Vervielfältigung verboten.",contact:{title:"Kontakt",name:"Name",email:"E-Mail",msg:"Nachricht",send:"Senden",sent:"Gesendet! Vielen Dank.",err:"Senden fehlgeschlagen. Bitte erneut versuchen."}},
  pt:{name:"Português",nav:{map:"Locais"},hero:{t:"Paisagens do Japão",s:"ー Japão em foco ー",d:"Uma coleção de fotos de paisagens tiradas por todo o Japão"},mapL:"Locais de fotos",mapH:"Clique numa prefeitura destacada → ver fotos",backMap:"Voltar ao mapa",lang:"Idioma",ft:"Sinta-se à vontade para entrar em contato.",scroll:"← Deslizar / Rolar →",oki:"Okinawa",tapHint:"Toque novamente → fotos",mapZoomOn:"Pinça para ampliar",mapZoomOff:"Sair do zoom",mapZoomReset:"Redefinir",footer2:"Reprodução não autorizada proibida.",contact:{title:"Contato",name:"Nome",email:"E-mail",msg:"Mensagem",send:"Enviar",sent:"Enviado! Obrigado.",err:"Falha no envio. Tente novamente."}},
