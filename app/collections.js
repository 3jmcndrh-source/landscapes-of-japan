...
export const COLLECTIONS = {
  "cherry-blossoms": {
    locs: [
      "新倉山浅間公園", "河口湖", "高遠城址公園", "駒つなぎの桜",
      "城山公園(松本市)", "高島公園(諏訪市)", "弘法山古墳", "安養寺",
      "中町通り(松本市)", "立石公園", "松本城", "松本市新村",
    ],
    name: {
  ...
  "autumn-foliage": {
    locs: ["東福寺", "東福寺 通天橋", "清水寺", "清水寺 紅葉ライトアップ", "金閣寺", "紅葉", "紅葉ライトアップ"],
    name: {
  ...
  "temples-shrines": {
    locs: ["清水寺", "清水寺周辺", "清水寺 三重塔", "清水寺 本堂", "金閣寺", "平等院鳳凰堂", "東福寺", "東福寺 通天橋", "東寺", "東寺 五重塔", "八坂の塔", "伊勢神宮", "おはらい町・おかげ横丁", "夫婦岩", "法隆寺", "法隆寺 夢殿", "安養寺"],
    name: {
